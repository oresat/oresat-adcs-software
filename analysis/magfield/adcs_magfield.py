...
if __name__ == "__main__":
    ...
    ax.plot3D(*adcs_WMM_mag_error.T, marker='.', label='ADCS 1st Deg error(original recipe) ')
    ax.plot3D(*adcs_WMM_mag_error2.T, marker='.',label='ADCS 1st Deg error(cbd recipe)')
    ax.set_xlabel(r"x-axis ($\mu$T)")
    ax.set_ylabel(r"y-axis ($\mu$T)")
    ax.set_zlabel(r"z-axis ($\mu$T)")
    ...
    ax.plot(adcs_WMM_mag_angle, label='ADCS 1st DEG error(original)')
    ax.plot(adcs_WMM_mag_angle2, label='ADCS 1st  DEG error(cbd recipe)')
