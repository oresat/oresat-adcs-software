...
The hardware implementation interfaces with real sensors and actuators via a service-based architecture.
...
All angular velocities and control torques are expressed in the body frame. Appendix elaborates on reference frame nomenclature.