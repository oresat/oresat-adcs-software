...
\begin{itemize}
	\item Body frame (B): A coordinate system fixed to the spacecraft, with axes aligned to the spacecraft geometry. All onboard quantities such as angular velocity, control torque, and actuator commands are expressed in this frame.
