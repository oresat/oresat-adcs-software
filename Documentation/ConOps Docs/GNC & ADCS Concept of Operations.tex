...
\begin{document}
	...
	No image similar to that seen in \Cref{fig:OreSat1} is available to illustrate the SENTINEL axis definitions at the time of writing, which are similar to those of OreSat1, but rotated about the +X axis by 180 degrees:
